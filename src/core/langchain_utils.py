"""
RAG chain for rag-multiagent-2026, built directly on langchain-core (LCEL).
...
QA_SYSTEM = (
    "You are a helpful assistant for rag-multiagent-2026. Use the following retrieved "
